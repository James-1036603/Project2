...
void Engine::input(float& dtAsSeconds)
{
    ...
    while(_window.pollEvent(event))
    {
        ...
        case sf::Event::KeyPressed://If a key was pressed
            ...
            if(sf::Keyboard::isKeyPressed(sf::Keyboard::Space)) _thePlayer.playerShoot(dtAsSeconds); //Shoot //Keep as a different abstraction. Maybe make an enum that says it is a friendly bullet. Also easier to interact and shoot
        default:
            break;
        }
